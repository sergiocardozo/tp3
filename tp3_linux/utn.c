...
//*******************************************************
int utn_getFloat(char* msg, char* msgError, int minSize, int maxSize, int min, int max, int reintentos, float* input) // acepta numeros con decimales
{
    int retorno=-1;
    char bufferStr[maxSize];
...
//*************************************************************
int utn_getTelefono(char* msg, char* msgError, int minSize, int maxSize, int min, int max, int reintentos, char* input) // Valida telefono con guiones o espacios y solo numeros naturales
{
    int retorno=-1;
    char bufferStr[maxSize];
...
//***************************************
int utn_getDNI(char* msg, char* msgError, int minSize, int maxSize, int reintentos, char* input) // Valida DNI con numeros naturales y puntos
{
...
//***************************************
int utn_getCUIT(char* msg, char* msgError, int reintentos, char* input) // Valida CUIT con numeros naturales y guiones
{
...
//*************************************************************
int utn_getEmail(char* msg, char* msgError, int minSize, int maxSize, int reintentos, char* input) // Valida email con arroba, -, +, y datos alfanumericos
{
    int retorno=-1;
    char bufferStr[maxSize];
